...
public class Grafo_TipoA {
    ...
    public Vertice vertice01 = new Vertice(1, POA, FLO);
    public Vertice vertice02 = new Vertice(1, POA, BLU);
    public Vertice vertice03 = new Vertice(1, FLO, BLU);
    public Vertice vertice04 = new Vertice(1, FLO, CUR);
    public Vertice vertice05 = new Vertice(1, FLO, RJO);
    public Vertice vertice06 = new Vertice(1, BLU, CUR);
    public Vertice vertice07 = new Vertice(1, CUR, LON);
    public Vertice vertice08 = new Vertice(1, CUR, SPO);
    public Vertice vertice09 = new Vertice(1, LON, SPO);
    public Vertice vertice10 = new Vertice(1, LON, BAU);
    public Vertice vertice11 = new Vertice(1, SPO, RJO);
    public Vertice vertice12 = new Vertice(1, SPO, CAM);
    public Vertice vertice13 = new Vertice(1, SPO, SJC);
    public Vertice vertice14 = new Vertice(1, SJC, CAM);
    public Vertice vertice15 = new Vertice(1, RJO, SJC);
    public Vertice vertice16 = new Vertice(1, RJO, BHO);
    public Vertice vertice17 = new Vertice(1, RJO, SLV);
    public Vertice vertice18 = new Vertice(1, BHO, SJC);
    public Vertice vertice19 = new Vertice(1, BHO, BSB);
    public Vertice vertice20 = new Vertice(1, CAM, BAU);
    public Vertice vertice21 = new Vertice(1, CAM, RBP);
    public Vertice vertice22 = new Vertice(1, RBP, BSB);
    public Vertice vertice23 = new Vertice(1, BAU, CPG);
    public Vertice vertice24 = new Vertice(1,CPG, CUI);
    public Vertice vertice25 = new Vertice(1, CUI, MAN);
    public Vertice vertice26 = new Vertice(1, MAN, BEL);
    public Vertice vertice27 = new Vertice(1, BEL, NTL);
    public Vertice vertice28 = new Vertice(1, BSB, MAN);
    public Vertice vertice29 = new Vertice(1, BSB, NTL);
    public Vertice vertice30 = new Vertice(1, NTL, REC);
    public Vertice vertice31 = new Vertice(1, REC, SLV);
    public Vertice vertice32 = new Vertice(1, SLV, NTL);
