...
public class GraphB {
    ...
    public Vertex vertex01 = new Vertex(6, POA, FLO);
    public Vertex vertex02 = new Vertex(7, POA, BLU);
    public Vertex vertex03 = new Vertex(1, FLO, BLU);
    public Vertex vertex04 = new Vertex(2, FLO, CUR);
    public Vertex vertex05 = new Vertex(12, FLO, RJO);
    public Vertex vertex06 = new Vertex(2, BLU, CUR);
    public Vertex vertex07 = new Vertex(6, CUR, LON);
    public Vertex vertex08 = new Vertex(5, CUR, SPO);
    public Vertex vertex09 = new Vertex(7, LON, SPO);
    public Vertex vertex10 = new Vertex(3, LON, BAU);
    public Vertex vertex11 = new Vertex(5, SPO, RJO);
    public Vertex vertex12 = new Vertex(1, SPO, CAM);
    public Vertex vertex13 = new Vertex(2, SPO, SJC);
    public Vertex vertex14 = new Vertex(2, SJC, CAM);
    public Vertex vertex15 = new Vertex(3, RJO, SJC);
    public Vertex vertex16 = new Vertex(7, RJO, BHO);
    public Vertex vertex17 = new Vertex(20, RJO, SLV);
    public Vertex vertex18 = new Vertex(7, BHO, SJC);
    public Vertex vertex19 = new Vertex(9, BHO, BSB);
    public Vertex vertex20 = new Vertex(3, CAM, BAU);
    public Vertex vertex21 = new Vertex(2, CAM, RBP);
    public Vertex vertex22 = new Vertex(8, RBP, BSB);
    public Vertex vertex23 = new Vertex(10, BAU, CPG);
    public Vertex vertex24 = new Vertex(8, CPG, CUI);
    public Vertex vertex25 = new Vertex(20, CUI, MAN);
    public Vertex vertex26 = new Vertex(18, MAN, BEL);
    public Vertex vertex27 = new Vertex(21, BEL, NTL);
    public Vertex vertex28 = new Vertex(22, BSB, MAN);
    public Vertex vertex29 = new Vertex(22, BSB, NTL);
    public Vertex vertex30 = new Vertex(4, NTL, REC);
    public Vertex vertex31 = new Vertex(8, REC, SLV);
    public Vertex vertex32 = new Vertex(15, SLV, NTL);
