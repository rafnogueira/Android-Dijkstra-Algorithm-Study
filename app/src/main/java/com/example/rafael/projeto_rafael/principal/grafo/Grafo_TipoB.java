...
public class Grafo_TipoB {
    ...
    public Vertice vertice01 = new Vertice(6, POA, FLO);
    public Vertice vertice02 = new Vertice(7, POA, BLU);
    public Vertice vertice03 = new Vertice(1, FLO, BLU);
    public Vertice vertice04 = new Vertice(2, FLO, CUR);
    public Vertice vertice05 = new Vertice(12, FLO, RJO);
    public Vertice vertice06 = new Vertice(2, BLU, CUR);
    public Vertice vertice07 = new Vertice(6, CUR, LON);
    public Vertice vertice08 = new Vertice(5, CUR, SPO);
    public Vertice vertice09 = new Vertice(7, LON, SPO);
    public Vertice vertice10 = new Vertice(3, LON, BAU);
    public Vertice vertice11 = new Vertice(5, SPO, RJO);
    public Vertice vertice12 = new Vertice(1, SPO, CAM);
    public Vertice vertice13 = new Vertice(2, SPO, SJC);
    public Vertice vertice14 = new Vertice(2, SJC, CAM);
    public Vertice vertice15 = new Vertice(3, RJO, SJC);
    public Vertice vertice16 = new Vertice(7, RJO, BHO);
    public Vertice vertice17 = new Vertice(20, RJO, SLV);
    public Vertice vertice18 = new Vertice(7, BHO, SJC);
    public Vertice vertice19 = new Vertice(9, BHO, BSB);
    public Vertice vertice20 = new Vertice(3, CAM, BAU);
    public Vertice vertice21 = new Vertice(2, CAM, RBP);
    public Vertice vertice22 = new Vertice(8, RBP, BSB);
    public Vertice vertice23 = new Vertice(10, BAU, CPG);
    public Vertice vertice24 = new Vertice(8, CPG, CUI);
    public Vertice vertice25 = new Vertice(20, CUI, MAN);
    public Vertice vertice26 = new Vertice(18, MAN, BEL);
    public Vertice vertice27 = new Vertice(21, BEL, NTL);
    public Vertice vertice28 = new Vertice(22, BSB, MAN);
    public Vertice vertice29 = new Vertice(22, BSB, NTL);
    public Vertice vertice30 = new Vertice(4, NTL, REC);
    public Vertice vertice31 = new Vertice(8, REC, SLV);
    public Vertice vertice32 = new Vertice(15, SLV, NTL);
