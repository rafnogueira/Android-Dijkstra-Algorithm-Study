...
import java.util.List;
    ...
    public class GraphC {
        ...
        public Vertex vertex01 = new Vertex(2   , POA, FLO);
        public Vertex vertex02 = new Vertex(2  , POA, BLU);
        public Vertex vertex03 = new Vertex(3 , FLO, BLU);
        public Vertex vertex04 = new Vertex(5 , FLO, CUR);
        public Vertex vertex05 = new Vertex(10 ,  FLO, RJO);
        public Vertex vertex06 = new Vertex(5, BLU, CUR);
        public Vertex vertex07 = new Vertex(2 , CUR, LON);
        public Vertex vertex08 = new Vertex(10 , CUR, SPO);
        public Vertex vertex09 = new Vertex(2 , LON, SPO);
        public Vertex vertex10 = new Vertex(2 , LON, BAU);
        public Vertex vertex11 = new Vertex(15 , SPO, RJO);
        public Vertex vertex12 = new Vertex(7 , SPO, CAM);
        public Vertex vertex13 = new Vertex(16 , SPO, SJC);
        public Vertex vertex14 = new Vertex(10, SJC, CAM);
        public Vertex vertex15 = new Vertex(10, RJO, SJC);
        public Vertex vertex16 = new Vertex(6  , RJO, BHO);
        public Vertex vertex17 = new Vertex(6  ,  RJO, SLV);
        public Vertex vertex18 = new Vertex(8  , BHO, SJC);
        public Vertex vertex19 = new Vertex(6  , BHO, BSB);
        public Vertex vertex20 = new Vertex(6  , CAM, BAU);
        public Vertex vertex21 = new Vertex(4 , CAM, RBP);
        public Vertex vertex22 = new Vertex(4 , RBP, BSB);
        public Vertex vertex23 = new Vertex(3 ,  BAU, CPG);
        public Vertex vertex24 = new Vertex(2 , CPG, CUI);
        public Vertex vertex25 = new Vertex(3 ,  CUI, MAN);
        public Vertex vertex26 = new Vertex(2 ,  MAN, BEL);
        public Vertex vertex27 = new Vertex(3 ,  BEL, NTL);
        public Vertex vertex28 = new Vertex(6 ,  BSB, MAN);
        public Vertex vertex29 = new Vertex(7 ,  BSB, NTL);
        public Vertex vertex30 = new Vertex(3  , NTL, REC);
        public Vertex vertex31 = new Vertex(5  , REC, SLV);
        public Vertex vertex32 = new Vertex(4  ,  SLV, NTL);
